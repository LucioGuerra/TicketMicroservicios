INSERT INTO requirement_db.public.requirement (
    ...
    updated_at
      ...
      ('Requisito 3', 'REQ-000000000000003', 'Descripción del requisito 3', 'CLOSED', 'LOW', 3, 202, 3, 1, FALSE, NOW(), NOW()),
      ...
      ('Requisito 6', 'REQ-000000000000006', 'Descripción del requisito 6', 'CLOSED', 'HIGH', 6, 204, 3, 3, FALSE, NOW(), NOW()),
      ...
      ('Requisito 9', 'REQ-000000000000009', 'Descripción del requisito 9', 'CLOSED', 'MEDIUM', 9, 206, 3, 1, FALSE, NOW(), NOW()),
